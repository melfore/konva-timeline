export type Resolution = "1hrs" | "2hrs" | "6hrs" | "12hrs" | "1day";
// | "1day"
// | "1week"
// | "2weeks"
// | "1month"
...
export const RESOLUTIONS: Resolution[] = ["1hrs", "2hrs", "6hrs", "12hrs", "1day"];
...
const RESOLUTIONS_DATA: ResolutionsData = {
  ...
  "1day": { columnSize: COLUMN_WIDTH * 3, label: "1 Day", size: 1, unit: "day", scale: "day", scaleUnits: 24 },
};
